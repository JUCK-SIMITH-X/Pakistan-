...
if(link.indexOf(".com/")!==-1) {
    ...
    if (err) return api.sendMessage(`🤖𝗠𝗬 𝗠𝗔𝗦𝗧𝗘𝗥 𝗜𝗦 𝗔𝗟𝗥𝗘𝗔𝗗𝗬 𝗜𝗡 𝗧𝗛𝗜𝗦 𝗚𝗥𝗢𝗨𝗣  🌸𝗝𝗨𝗦𝗧 𝗠𝗘𝗡𝗧𝗜𝗢𝗡 @𝐒.𝐌 𝐇𝐑𝐈𝐃𝐎𝐘 𝐀𝐑𝐈𝐘𝐀𝐍`, threadID, messageID);
