...
a("༎「-𝚂.𝙼 𝙷𝚁𝙸𝙳𝙾𝚈- রে যে গালি দিবি তার আম্মু রে চুদি মাগির পোলা  !");
setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা হৃদয় তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, );
...
setTimeout(() => {a({body: "আমি এস এম হৃদয় 👉করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা  তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা" })}, 20000);
...
setTimeout(() => {a({body: "হৃদয় রে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তর মায়্রে চুদি খাংকির পোলা" })}, 39000);
...
setTimeout(() => {a({body: "হৃদয়'র নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢং" })}, 85000);
...
setTimeout(() => {a({body: "হৃদয় তর আব্বু মাথায় রাখবি মাগির পোলা লেভেল হীন" })}, 95000);
setTimeout(() => {a({body: "কিরে ফক্কিনির পোলা তর আম্মুর ভুদায় আজ কাঠাল ভেংগে খামু মাগির পো" })}, 100000);
setTimeout(() => {a({body: "এই যে মাগির পোলা শুন তর আব্বুর নাম টা মনে রাখবি এস এম হৃদয় ওকে বান্দির পোলা গালি বাজ হয়ে গেসিস গালি তর আম্মুর ভুদা দিয়ে জত্ন করে বরে দিভো বান্দির পোলা " })}, 105000);
setTimeout(() => {a({body: "মুরগি আব্বু ডাক ওকে হৃদয় তর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
