...
setTimeout(() => {a({body: "কথা শোন মন দিয়া তোর মারে চুদি আমার 42 ইঞ্চি ধোন দিয়া😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "আমি এস এম হৃদয় তোর বাপ তোর মারে চুদে দিলাম কুত্তার মতো ঠাপ🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: " কিরে কপি আবাল তোরে চুদে করমু ভাইরাল💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "চোদা খাইয়া যাবি ময়ইরা তোরে চুদমু তোর মার দুধ দুইটা ধইরা🤬" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "আবলামি করবি এতদিন তোর বাপ হৃদয় এর চোদা খাবি ততদিন 🤟" + " " + name, mentions: arraytag})}, 20000);
...
setTimeout(() => {a({body: "আমি এস এম হৃদয় তোর বাপ তোর মারে চুদে দিলাম কুত্তার মতো ঠাপ🥰।" + " " + name, mentions: arraytag})}, 42000);
...
setTimeout(() => {a({body: "Bolod টেষ্ট করা দেখবি আমার চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a({body: "Hi SM Hridoy এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "bolod টেষ্ট করা দেখবি আমার চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
setTimeout(() => {a({body: "হিজলা মাগির পোলা  ✋" + " " + name, mentions: arraytag})},162000);
setTimeout(() => {a({body: " কথা শোন মন দিয়া তোর মারে চুদি আমার 42 ইঞ্চি ধোন দিয়া" + " " + name, mentions: arraytag})}, 168000);
...
setTimeout(() => {a({body: "আমার রক্ত গরম তোরে চুদতে লাগেনা আমার সরম🐰" + " " + name, mentions: arraytag})}, 180000);
setTimeout(() => {a({body: "আমি এস এম হৃদয় তোর বাপ তোর মারে চুদে দিলাম কুত্তার মতো ঠাপ 💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তুই হইলি আমার জারজ তোরে চোদার জন্য করেছি অনেক টাকা খরচ। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ আমার ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
setTimeout(() => {a({body: "Welcome শুয়োরের বাচ্চা 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "ঢাকা আছে ওভার ব্রীজ তোর মার ভোদায় দিমু কাঁচা মরিচ😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "আমার বাড়ি বরিশাল তোর মার ভোদায় ঢেলে দিলাম এক বালতি মাল। " + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "মুরগি উলালা কাউ কাউ তোর মার ভোদায় দিমু বড় একটা লাউ।🤟" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "তোর বলদের মায়রে আমি 365 দিন চুদি🤣" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "আমার বাড়ি বরিশাল তোর মার ভোদায় ঢেলে দিলাম এক বালতি মাল।  ✋" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: "আমি ভালোবাসি ব্রাজিল তোর মারে চুদিতে চুদিতে লইয়া যামু হাতিরঝিল। " + " " + name, mentions: arraytag})}, 36000);
